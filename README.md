...
# Getting started
You need to be able to run the CESM model, or another GCM which used RRTMG radiation scheme. You also need the climlab by Brian E.J., Rose ()

# Codes
Radiation.F90, radsw.F90, radlw.F90 are the modified RRTMG codes I write to output the necessary inputs to the offline RRTMG, including the specific humidity, ozone, cloud, etc. 
