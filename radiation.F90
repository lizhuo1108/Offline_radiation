...
subroutine radiation_init(pbuf2d)
   ...
   ! Shortwave radiation
   call addfld ('PBR',             (/ 'lev' /),  'I','dynes/cm2','Model mid-level pressures',              sampling_seq='rad_lwsw')
   call addfld ('PNM',             (/ 'ilev' /), 'I','dynes/cm2','Model interface pressures',              sampling_seq='rad_lwsw')
   call addfld ('TMID',            (/ 'lev' /),  'I','K',   'Model mid-level temperature',                 sampling_seq='rad_lwsw')
   call addfld ('TINT',            (/ 'ilev' /), 'I','K',   'Model interface temperature',                 sampling_seq='rad_lwsw')
   call addfld ('SP_HUM',          (/ 'lev' /),  'I','kg/kg','Specific humidity for radiation',            sampling_seq='rad_lwsw')
   call addfld ('O3_rad',          (/ 'lev' /),  'I','kg/kg','O3 mass mixing ratio',                       sampling_seq='rad_lwsw')
   call addfld ('CO2_rad',         (/ 'lev' /),  'I','kg/kg','CO2 mass mixing ratio',                      sampling_seq='rad_lwsw')
   call addfld ('CH4_rad',         (/ 'lev' /),  'I','kg/kg','CH4 mass mixing ratio',                      sampling_seq='rad_lwsw')
   call addfld ('N2O_rad',         (/ 'lev' /),  'I','kg/kg','N2O mass mixing ratio',                      sampling_seq='rad_lwsw')
   call addfld ('CFC11_rad',       (/ 'lev' /),  'I','kg/kg','CFC11 mass mixing ratio',                    sampling_seq='rad_lwsw')
   call addfld ('CFC12_rad',       (/ 'lev' /),  'I','kg/kg','CFC12 mass mixing ratio',                    sampling_seq='rad_lwsw')
   call addfld ('O2_rad',          (/ 'lev' /),  'I','kg/kg','O2 mass mixing ratio',                       sampling_seq='rad_lwsw')
   call addfld ('CLD_rad',         (/ 'lev' /),  'I','1','Cloud fraction for radiation',                   sampling_seq='rad_lwsw')
   call addfld ('CICEWP_rad',      (/ 'lev' /),  'I','g/m2','in-cloud cloud ice water path',               sampling_seq='rad_lwsw')
   call addfld ('CLIQWP_rad',      (/ 'lev' /),  'I','g/m2','in-cloud cloud liquid water path',            sampling_seq='rad_lwsw')
   call addfld ('REI_rad',         (/ 'lev' /),  'I','microns','effective radius ice',                     sampling_seq='rad_lwsw')
   call addfld ('REL_rad',         (/ 'lev' /),  'I','microns','effective radius liquid',                  sampling_seq='rad_lwsw')
   call addfld ('ASDIR_rad',       horiz_only,   'I','1','0.2-0.7 micro-meter srfc alb: direct rad',       sampling_seq='rad_lwsw')
   call addfld ('ASDIF_rad',       horiz_only,   'I','1','0.2-0.7 micro-meter srfc alb: diffuse rad',      sampling_seq='rad_lwsw')
   call addfld ('ALDIR_rad',       horiz_only,   'I','1','0.7-5.0 micro-meter srfc alb: direct rad',       sampling_seq='rad_lwsw')
   call addfld ('ALDIF_rad',       horiz_only,   'I','1','0.7-5.0 micro-meter srfc alb: diffuse rad',      sampling_seq='rad_lwsw')
   call addfld ('COSZRS',          horiz_only,   'I','1','Cosine solar zenith angle',                      sampling_seq='rad_lwsw')
   call addfld ('ECCF',            horiz_only,   'I','1','eccentricity factor',                            sampling_seq='rad_lwsw')
   ...
   call addfld ('FUS',             (/ 'ilev' /), 'I','W/m2','Shortwave upward flux',                       sampling_seq='rad_lwsw')
   call addfld ('FDS',             (/ 'ilev' /), 'I','W/m2','Shortwave downward flux',                     sampling_seq='rad_lwsw')
   ...
   call addfld ('FSNIRTOA',        horiz_only,   'A','W/m2','Net near-infrared flux (Nimbus-7 WFOV) at top of atmosphere',  &
                                                                                                           sampling_seq='rad_lwsw')
   call addfld ('FNS',             (/ 'ilev' /), 'I','W/m2','Net SW flux at interface',                    sampling_seq='rad_lwsw')
...
subroutine radiation_tend( &
   ...
   real(r8) :: esdf(pcols)          ! Earth/sun distance factor
   ...
   call outfld('REL_rad', rel  ,pcols,lchnk)
   call outfld('REI_rad', rei  ,pcols,lchnk)
   ...
   if (dosw .or. dolw) then
      ...
      call outfld('CICEWP_rad', cicewp  ,pcols,lchnk)
      call outfld('CLIQWP_rad', cliqwp  ,pcols,lchnk)
      ...
      esdf(:)=eccf
      call outfld('PBR',pbr  ,pcols,lchnk)
      call outfld('PNM',pnm  ,pcols,lchnk)
      call outfld('ECCF',esdf  ,pcols,lchnk)
      call outfld('ASDIR_rad',cam_in%asdir  ,pcols,lchnk)
      call outfld('ASDIF_rad',cam_in%asdif  ,pcols,lchnk)
      call outfld('ALDIR_rad',cam_in%aldir  ,pcols,lchnk)
      call outfld('ALDIF_rad',cam_in%aldif  ,pcols,lchnk)
      ...
      if (dosw) then
         ...
         call outfld('O2_rad',o2  ,pcols,lchnk)
      ...
      if (dolw) then
         ...
         call outfld('N2O_rad',n2o  ,pcols,lchnk)
         call outfld('CH4_rad',ch4  ,pcols,lchnk)
         call outfld('CFC11_rad',cfc11  ,pcols,lchnk)
         call outfld('CFC12_rad',cfc12  ,pcols,lchnk)
         ...
         call outfld('TMID    ',state%t  ,pcols,lchnk)
